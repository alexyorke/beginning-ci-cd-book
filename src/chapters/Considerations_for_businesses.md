...
- CI/CD is about having _more_ control over your process. Automation is strict and clear. If it works, then you know that the instructions work. The instructions are purpose-built for a computer to run, thus, the computer cannot tolerate ambiguity. There is no room for misinterpretation.
...
- Some teams may be already entrenched with the branch pattern. Migrating to CI/CD is a process, and so identifying and making the existing process more efficient _to facilitate_ continuous integration and deployment starts with having an effective branching strategy to avoid big-bang integrations.
...
- Continuous improvement: avoiding anti-patterns in CI
  ...
  - Medium relevant
    ...
    - Feature branches are used instead of feature toggles (R6)
      ...
      - [[2007.05760.pdf (arxiv.org)]{.underline}](https://arxiv.org/pdf/2007.05760.pdf) feature toggles _might be better_

      - [_[Exploring Differences and Commonalities between Feature Flags and Configuration Options (acm.org)]{.underline}_](https://dl.acm.org/doi/pdf/10.1145/3377813.3381366)
