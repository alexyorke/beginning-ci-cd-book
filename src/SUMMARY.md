...
- [Setting up Your Repository](chapters/Setting_up_your_repository_Build_tools_and_more.md)
...
- [Security and Governance Tips](aside/Security_and_Governance_Tips.md)
- [CI/CD Observability and Telemetry](aside/CI_CD_Observability_and_Telemetry.md)
- [Reproducible Builds and SBOMs](aside/Reproducible_Builds_and_SBOMs.md)
- [Feature Toggles: Key Points](aside/Feature_Toggles_Key_Points.md)
- [Podcast: Complexity Key Points](aside/Podcast_Complexity_Key_Points.md)
- [Podcast: Overcoming Blockers Key Points](aside/Podcast_Overcoming_Blockers_Key_Points.md)
- [Agile Embedded: CD in Reverse](aside/Agile_Embedded_CD_Reverse.md)
- [Adopting CI/CD and Makefile Example](aside/Adopting_CI_CD_and_Makefile.md)
- [IDE Build Processes](aside/IDE_Build_Processes.md)
- [Selecting Build Tools](aside/Selecting_Build_Tools.md)
- [Dependabot and Updating Dependencies](aside/Dependabot_and_Updating_Dependencies.md)
- [Budgeting and Cost Management](aside/Budgeting_and_Cost_Management.md)
- [CI/CD Quick Tips](aside/Cost-Effective_CI_CD_Quick_Tips.md)
- [File Path Globs by Category](aside/Additional_File_Path_Globs_by_Category.md)
- [Outputs and Job Communication](aside/GitHub_Actions_Outputs_and_Job_Communication.md)
- [CI/CD Security Key Points](aside/CI_CD_Security_Key_Points.md)
- [Security Measures in GitHub Actions Enterprise](aside/Implementing_Security_Measures_in_GitHub_Actions_Enterprise.md)
- [Application Monitoring](aside/Application_Monitoring.md)
- [Runner Software and Installing Dependencies](aside/Runner_Software_and_Installing_Dependencies.md)
...
- [Reporting, Code Coverage and SonarCloud](aside/Reporting_Code_Coverage_and_SonarCloud.md)
 - [CI/CD Software and Self-Hosted Runner](aside/CI_CD_Providers_and_Self_Hosted_Runner.md)
 - [Important Terms and Workflow Steps](aside/Important_Terms_and_Workflow_Steps.md)
 - [Environments and Environment Variables](aside/Environments_and_Variables.md)
 - [Control Flow in GitHub Actions](aside/Control_Flow_in_GitHub_Actions.md)
 - [CI/CD Overview and Diagram](aside/CI_CD_Overview_and_Diagram.md)
 - [Feature Flags and Monitoring](aside/Feature_Flags_and_Monitoring.md)
 - [Security and Docker Workflow Notes](aside/Security_and_Docker_Workflow_Notes.md)
 - [Workflow Design, Getting Started, and .gitignore](aside/Workflow_Design_Getting_Started_and_Gitignore.md)
 - [Local Dev Environment and Codespaces](aside/Local_Dev_Environment_and_Codespaces.md)
 - [Unanswered Questions and References](aside/Unanswered_Questions_and_References.md)
